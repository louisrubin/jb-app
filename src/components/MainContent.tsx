...
export default function MainContent() {
  ...
  return (
    ...
    >
      ...
      <div
        id="main-content"
        className="relative text-center text-white pt-[20vh] md:pt-[25%] lg:pt-[20vh] xl:pt-[25vh]"
        >
          ...
          <p className="especialidad w-3/4 md:w-2/4 lg:w-1/2 mx-auto my-6 md:my-[6vh] lg:my-[5vh] xl:my-[6vh] drop-shadow-[2px_5px_3px_rgba(0,0,0,1)]">
